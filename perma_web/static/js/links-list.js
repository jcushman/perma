$(function(){
    ...
    var notesSaveNeeded = false,
        lastNotesSaveTime = 0,
        saveBufferSeconds = 3;
    linkTable.on('click', '.linky-details-link a', function(){
        console.log("but");
    ...
    var titleSaveNeeded = false,
        lastTitleSaveTime = 0;
    linkTable.on('mousedown click', '.linky-abbr-title input', function(e){
        e.stopPropagation();
    }).on('input propertychange', '.linky-abbr-title input', function(){
        ...
        .jstree({
            core: {
                check_callback: function (operation, node, node_parent, node_position, more) {
                    ...
                    var tree = this;
                    /* "copy_node" Object { id: true, text: "..." } Object { id: "j1_3", text: "Vesting Member

                                        ", icon: true, parent: "j1_2", parents: Array[2], children: Array[1], children_d: Array[2], data: Object, state: Object, li_attr: Object, 2 more… } 0 Object { core: true, is_multi: null, is_foreign: true } */
                    if(more.is_foreign){
                        // link dragged onto folder
                        if(operation=='copy_node'){
                            moveItems(getFolderID(node_parent), [node.id], []).done(function () {
                                showFolderContents(getFolderID(tree.get_selected(true)[0]));
                            });
                        }
                    }else {
                        ...
                        if (operation == 'rename_node') {
                            ...
                            moveItems(getFolderID(node_parent), [], [getFolderID(node)]).done(function () {
                                allowedEventsCount++;
